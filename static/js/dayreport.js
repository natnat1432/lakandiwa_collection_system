$(document).ready(function() {
  ...
  function refreshPage(){
    ...
    window.location.href= `/reports/${distinct_date}/${distinct_day}?sort_filter=${sort_filter}&student_filter=${student_filter}&excempted_filter=${excempted_filter}&course_filter=${course_filter}&year_filter=${year_filter}&void_filter=${void_filter}&search_query=${search_query}`;
  }
